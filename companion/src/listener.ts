...
export function lanAddresses(interfaces?: ReturnType<typeof networkInterfaces>): string[] {
  ...
  try {
    ...
    // Sandboxed/container runtimes can refuse uv_interface_addresses. A
    // missing address disables discovery; it must not crash pairing or the
    // already-authenticated proxy surface.
    return [];
  }
