                    ...
                    {members.map((member) => {
                      ...
                      return (
                        ...
                        >
                          <MausAvatar
                            color={member.color}
                            body={member.mascotBody}
                            eyes={member.mascotEyes}
                            accessory={member.mascotAccessory}
...
export function GroupView({ group }: { group: Group }) {
  ...
  const memberMauses = members.map((b) => (
    ...
    >
      <MausAvatar color={b.color} body={b.mascotBody} eyes={b.mascotEyes} accessory={b.mascotAccessory} state={normalizeState(b.mascotExpression) ?? "happy"} size={24} animated={false} />
            ...
            <TurnPresence
              avatar={
                <MausAvatar
                  ...
                  body={presenceSpeaker?.mascotBody}
                  eyes={presenceSpeaker?.mascotEyes}
                  accessory={presenceSpeaker?.mascotAccessory}
