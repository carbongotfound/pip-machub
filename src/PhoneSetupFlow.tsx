...
export interface PhoneDevice {
  ...
  /** Missing on older sidecars; absence is always treated as off. */
...
export type CompanionBridge = {
  ...
  administration: (deviceId: string, allowed: boolean) => Promise<CompanionState>;
  ...
  if (c.phase === "intro") {
    return (
      <div className="flex flex-col items-center text-center">
        ...
        <h2 className="mt-4 text-[19px] font-semibold text-ink">Use Pip from your phone</h2>
  ...
  if (c.phase === "success") {
    return (
      <div className="flex flex-col items-center py-6 text-center">
        ...
        >
          {variant === "onboarding" ? "Start using Pip" : "Done"}
        </button>
      </div>
    );
  }
