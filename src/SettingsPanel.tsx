    ...
    <aside className="animate-panel-in relative z-20 flex h-full w-[400px] shrink-0 flex-col border-l border-hairline/40 bg-panel">
      ...
      <div className="flex-1 overflow-y-auto px-5 pb-5">
        <div className="flex flex-col gap-4 pt-4">
          ...
          <div className="rounded-xl bg-accent/10 px-4 py-3 ring-1 ring-accent/20">
            <div className="text-[14px] font-medium text-ink">Character</div>
            <div className="mt-1 text-[12.5px] leading-relaxed text-ink-secondary">
              The role and personality below shape how {bot.name || "this agent"} thinks, speaks, and works. They are sent as real instructions on every task.
            </div>
          </div>
          ...
          <Field label="Personality & working instructions">
            <textarea
